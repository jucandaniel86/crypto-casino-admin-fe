...
//import reports
import Games from "../players/games.vue";
import Players from "./main.vue";
import Session from "../players/sessions.vue";
import Transactions from "../players/transactions.vue";
...
<template>
	<!-- REPORTS LOGIC -->
	<players @players:change-report="changeReport" @players:download="downloadCSVData"
		v-if="currentReport === PlayersReportEnum.PLAYERS" />
	<session @players:change-report="changeReport" @players:download="downloadCSVData"
		v-if="currentReport === PlayersReportEnum.SESSION" />
	<games @players:change-report="changeReport" @players:download="downloadCSVData"
		v-if="currentReport === PlayersReportEnum.GAMES" />
	<transactions @players:change-report="changeReport" @players:download="downloadCSVData"
